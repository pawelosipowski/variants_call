...
maxbadkmers=0       (mbk) Reads with more than this many matching kmers 
                    will be considered matching the reference.
minkmerfraction=0.0 (mkf) A reads needs at least this fraction of its total
                    ...
                    If this and maxbadkmers are set, the greater is used.
mincovfraction=0.0  (mcf) A reads needs at least this fraction of its total
                    ...
                    If specified, mcf overrides mbk and mkf.
